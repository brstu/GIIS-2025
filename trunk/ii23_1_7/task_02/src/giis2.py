...
class DataVisualizerApp:
    ...
    def select_column(self, title, message):
        ...
        if self.data is not None:
            ...
            combobox['values'] = self.data.columns.tolist()
    ...
    def plot_line(self):
        x_column, y_column = self.select_two_columns("Линейный график", "Выберите столбцы для осей X и Y")
        if x_column and y_column:
            self.figure.clear()
            ax = self.figure.add_subplot(111)
            ax.plot(self.data[x_column], self.data[y_column], label=f"{x_column} vs {y_column}")
    ...
    def plot_histogram(self):
        x_column = self.select_column("Гистограмма", "Выберите столбец для оси X")
        if x_column:
            self.figure.clear()
            ax = self.figure.add_subplot(111)
    ...
    def plot_pie(self):
        x_column = self.select_column("Круговая диаграмма", "Выберите столбец для построения")
        if x_column:
            self.figure.clear()
            ax = self.figure.add_subplot(111)
    ...
    def plot_boxplot(self):
        x_column = self.select_column("Boxplot", "Выберите столбец для построения")
        if x_column:
            self.figure.clear()
            ax = self.figure.add_subplot(111)
    ...
    def show_info(self):
        ...
        - Для круговой диаграммы и гистограммы используйте одну колонку.
        - Для линейного графика и диаграммы рассеяния используйте две колонки.
        """
