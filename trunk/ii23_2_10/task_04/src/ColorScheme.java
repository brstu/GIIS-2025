...
public class ColorScheme {
	...
	private void initBackrounds() {
		...
		background.put(-1, new Color(0X6A5ACD)); // Универсальная - сливовый
		background.put(-2, new Color(0XDC143C));  // Удаляющая - малиновый
		background.put(-3, new Color(0X32CD32));  // Перемешивающая - лаймовый
	}
